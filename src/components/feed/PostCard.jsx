export default function PostCard({ post }) {
  return (
    <div
      ...
      p-8 shadow-[0_20px_60px_rgba(0,0,0,0.06)]
      transition-all duration-300
      hover:-translate-y-1 hover:shadow-[0_30px_80px_rgba(0,0,0,0.08)]"
    >
      {/* Header */}
      <div className="flex items-center gap-4 mb-6">
        ...
        <div
          ...
          bg-gradient-to-br from-[#E8E5FF] to-[#DCD8FF]
          flex items-center justify-center
          text-[#6C63FF] font-semibold shadow-sm"
        >
